...
export const CoverPageSection: React.FC<CoverPageSectionProps> = ({ testDetails, variantsArray }) => {
    ...
    return (
        <Page size="A4" orientation="portrait" style={{ display: 'flex', flexDirection: 'column', gap: 40, padding: 40, backgroundColor: '#000000' }}>
            ...
            <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', gap: 20, marginBottom: 40 }}>
                <View style={{ backgroundColor: '#1A1D21', padding: 15, borderRadius: 8, flex: 1, maxWidth: 170, display: 'flex', justifyContent: 'center' }}>
                    <View style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', width: '100%', gap: 10 }}>
                        <View style={{ 
                            ...
                            <Text style={{ fontFamily: 'FontAwesome', fontSize: 16, color: '#FFFFFF', textAlign: 'center' }}>
                                {'\uf03a'}
                            </Text>
                        </View>
                        <View>
