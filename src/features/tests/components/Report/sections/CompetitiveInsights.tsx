...
const CompetitiveInsights: React.FC<CompetitiveInsightsProps> = ({ competitiveinsights }) => {
    ...
    const getShareOfBuyColor = (value: number) => {
        ...
        if (value > shareOfBuyRanks.min && value < shareOfBuyRanks.max) return 'bg-yellow-100';
        return '';
    };
        ...
        <div className="w-full p-6 bg-white rounded-lg shadow-sm">
            ...
            <div className="mb-6">
                ...
                <select
                    ...
                    className="p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-200 focus:border-blue-400 outline-none"
                >
                ...
                <table className="min-w-full border-collapse max-w-screen-md">
                    <thead>
                        <tr className="bg-gray-100 border-none">
                            ...
                            <th colSpan={5} className="border border-gray-300 p-2">Your Item vs Competitor</th>
                        </tr>
                        <tr className="bg-gray-200">
                            {['Picture', 'Share of Buy', 'Value', 'Aesthetics', 'Utility', 'Trust', 'Convenience'].map(header => (
                        ...
                        {filteredInsights.map((item, index) => (
                            <tr key={index} className="hover:bg-gray-100">
                                <td className="border border-gray-300 p-2">
                                    <a href={item.competitor_product_id.product_url} target="_blank" rel="noopener noreferrer">
                                ...
                                <td className={`border border-gray-300 p-2 ${item.count > 0 ? getShareOfBuyColor(item.share_of_buy) : ''}`}>
            ...
            <div className="space-y-2 mt-4 text-sm text-gray-600">
                <p>
                    ...
                    <span className="inline-flex items-center justify-center bg-blue-100 text-black rounded-full w-4 h-4 text-[10px] mx-1">🔍</span>
