...
export default function ExperienceSelection({ selectedExperience, onExperienceChange }: ExperienceSelectionProps) {
  useEffect(() => {
    if (!TIKTOK_SKIN_ENABLED && selectedExperience === 'tiktokshop') {
      onExperienceChange('amazon');
    }
  }, []);
  ...
  return (
    <div className="mt-8">
      ...
      <div className={`grid grid-cols-1 gap-6 ${TIKTOK_SKIN_ENABLED ? 'md:grid-cols-3' : 'md:grid-cols-2'}`}>
