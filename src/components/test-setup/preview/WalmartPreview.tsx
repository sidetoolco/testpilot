    ...
    <>
      ...
      <nav className="bg-[#C9DCFD] shadow-sm  border-b  border-gray-200 block relative z-30 p-1">
        <div className="max-w-full px-4 flex  items-center justify-center gap-6 overflow-x-auto scrollbar-hide">
          <a href="#" className="flex items-center gap-1 text-sm font-bold text-gray-800 hover:text-[#0071dc] whitespace-nowrap bg-white px-3 py-1 rounded-full shadow-sm">
            <Menu size={16}/><span>Departments</span>
          </a>
          <a href="#" className="text-sm font-bold text-gray-800 hover:text-[#0071dc] whitespace-nowrap bg-white px-3 py-1 rounded-full shadow-sm">
            Services
          </a>
          <a href="#" className="text-sm text-yellow-600 hover:text-yellow-700 whitespace-nowrap font-medium flex items-center gap-1 bg-white px-3 py-1 rounded-full shadow-sm">
            ⚡ Get it Fast
          </a>
          <a href="#" className="text-sm text-gray-800 hover:text-[#0071dc] whitespace-nowrap bg-white px-3 py-1 rounded-full shadow-sm">
            🆕 New Arrivals
          </a>
          <a href="#" className="text-sm text-gray-800 hover:text-[#0071dc] whitespace-nowrap bg-white px-3 py-1 rounded-full shadow-sm">
            🎒 Back to School
