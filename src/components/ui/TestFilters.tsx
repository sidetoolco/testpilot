      ...
      {isAdmin && (
        <div className="flex items-center gap-4">
          <input
            ...
            className="w-48 py-2 px-1 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-400 focus:border-transparent shadow-sm"
          />
        </div>
      )}
