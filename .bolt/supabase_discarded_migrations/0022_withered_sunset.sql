/*
  ...
  1. New Tables
    - test_sessions: Stores main test information
    - test_competitors: Links tests to competitor products
    - test_variations: Stores test variations (A/B/C)
...
-- Create test_sessions table with company_id included from the start
